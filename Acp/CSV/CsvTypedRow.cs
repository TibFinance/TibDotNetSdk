...
namespace Tib.Api.Acp.CSV
{
    ...
    public TransferDirectionEnum OperationType { get; set; }
    ...
    /// </summary>
    /// <value></value>
    public ProvinceStateIdEnum Province { get; set; }

    /// <summary>
    /// 
    /// </summary>
    /// <value></value>
    public CountryIdEnum Country { get; set; }
