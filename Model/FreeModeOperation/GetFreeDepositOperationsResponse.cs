...
{
    /// <summary>
    /// Represents the GetFreeDepositOperationsResponse model.
    /// </summary>
    public class GetFreeDepositOperationsResponse : ClientBaseResponse
    {
    ...
    public List<FreeDepositOperationModel> OperationList { get; set; }
